...
\end{comment}
The candidate solutions/ individuals are represented as permutations of the cities. The TSP problem is inherently a permutation problem as every city is visited exactly once. Concretely in Python an individual is represented by a numpy array of integers.
